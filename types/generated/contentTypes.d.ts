...
export interface ApiAllocationAllocation extends Schema.CollectionType {
  ...
  attributes: {
    ...
    companyImageUrl: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    recruitmentStages: Attribute.Component<'recruitment.stages', true> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
    ...
    automaticClosingDate: Attribute.DateTime &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
      }>;
    status: Attribute.Enumeration<['active', 'closed', 'cancelled', 'frozen']> &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: true;
        };
...
export interface ApiApplicantApplicant extends Schema.CollectionType {
  ...
  attributes: {
    curriculumURL: Attribute.String &
      Attribute.SetPluginOptions<{
        i18n: {
          localized: false;
        };
...
export interface ApiApplicationApplication extends Schema.CollectionType {
  ...
  attributes: {
    allocation: Attribute.Relation<
      'api::application.application',
      'manyToOne',
      'api::allocation.allocation'
    >;
    process: Attribute.Component<'recruitment.process', true>;
    applicant: Attribute.Relation<
      'api::application.application',
      'manyToOne',
      'api::applicant.applicant'
    >;
    wasHired: Attribute.Boolean;
    salaryExpectation: Attribute.Decimal &
      Attribute.SetMinMax<
        {
          max: 999999999;
        },
        number
      >;
    immediateAvailability: Attribute.Boolean;
    applicantName: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 1000;
      }>;
    applicantEmail: Attribute.String &
      Attribute.SetMinMaxLength<{
        maxLength: 5000;
      }>;
